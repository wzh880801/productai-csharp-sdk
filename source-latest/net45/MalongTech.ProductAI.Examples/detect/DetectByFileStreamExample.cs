...
namespace MalongTech.ProductAI.Examples
{
    ...
    /// </summary>
    class DetectByFileStreamExample : IExample
    {
        public void Run(IWebClient client)
        {
            ...
            System.IO.FileStream fs = new System.IO.FileStream(@".\detect\bed.jpg", System.IO.FileMode.Open);

            var request = new DetectByImageStreamRequest("detect", "_0000171")
            {
                ImageStream = fs,
