...
namespace MalongTech.ProductAI.Examples
{
    ...
    /// 对图片内容进行色彩分析
    /// </summary>
    class ColorAnalysisByFileStreamExample : IExample
    {
        public void Run(IWebClient client)
        {
            Console.WriteLine("==>  Demo - 色彩标注服务  <==");

            var request = new ColorClassifyByImageStreamRequest ()
            {
                ImageStream = new System.IO.FileStream(@".\color\f10.jpg", System.IO.FileMode.Open),
