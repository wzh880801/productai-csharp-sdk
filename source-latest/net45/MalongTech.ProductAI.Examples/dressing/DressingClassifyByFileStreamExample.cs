...
namespace MalongTech.ProductAI.Examples
{
    ...
    /// </summary>
    class DressingClassifyByFileStreamExample : IExample
    {
        public void Run(IWebClient client)
        {
            ...
            System.IO.FileStream fs = new System.IO.FileStream(@".\dressing\f10.jpg", System.IO.FileMode.Open);

            var request = new DressingClassifyByImageStreamRequest()
            {
                ImageStream = fs,
