...
namespace MalongTech.ProductAI.Examples
{
    /// <summary>
    /// 数据集操作
    /// https://api-doc.productai.cn/doc/pai.html#从数据集删除多条数据
    /// </summary>
    class DataSetBatchDeleteFilesExample : IExample
    {
        public void Run(IWebClient client)
        {
            Console.WriteLine("==>  Demo - 数据集操作  <==");
            Console.WriteLine("See https://api-doc.productai.cn/doc/pai.html#从数据集删除多条数据 for details.\r\n");

            var request = new DataSetBatchDeleteRequest("lqn2jj6z")
            {
