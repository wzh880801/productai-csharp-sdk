...
namespace MalongTech.ProductAI.Examples
{
    ...
    /// </summary>
    class ClassifyByFileStreamExample : IExample
    {
        public void Run(IWebClient client)
        {
            ...
            System.IO.FileStream fs = new System.IO.FileStream(@".\classify\f10.jpg", System.IO.FileMode.Open);
            
            var request = new ClassifyByImageStreamRequest("classify", "_0000039")
            {
                ImageStream = fs,
