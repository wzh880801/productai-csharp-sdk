...
{
    class ImageSearchByFileStreamExample : IExample
    {
        public void Run(IWebClient client)
        {
            ...
            var request = new ImageSearchByImageStreamRequest("k7h9fail")
            {
                ImageStream = new System.IO.FileStream(@".\classify\f10.jpg", System.IO.FileMode.Open),
